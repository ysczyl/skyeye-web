    ...
    <el-dialog title="定制标签" :visible.sync="dialogFormVisible">
      <el-form style="width: 500px;margin-left: calc(50% - 250px);" :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
        ...
        <el-form-item style="margin-left: 60px">
          <el-button style="width: 120px" type="primary" @click="dialogFormVisible = false">定制标签</el-button>
...
<!--        </el-collapse-item>-->
        <el-collapse-item name="2">
          ...
          <el-button style="float: right;margin-top: 10px;position: absolute;right: 20px;z-index: 999" @click="dialogFormVisible = true">定制标签</el-button>
          <el-table
            ref="filterTable"
            :data="tableData"
            style="width: 100%">
